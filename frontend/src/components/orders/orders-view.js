...
export class OrdersView{
  ...
  showOrder(order){
    ...
    document.getElementById('complete').innerText = (order.completeDate) ? (new Date(order.completeDate)).toLocaleDateString('ru-RU') : 'Неизвестна';
    ...
    if(order.freelancer.name && order.freelancer.lastName){
